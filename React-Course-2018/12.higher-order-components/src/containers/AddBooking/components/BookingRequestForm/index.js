...
class BookingRequestForm extends React.Component {
  ...
  componentDidMount() {
    const url = 'https://react-forms-backend.herokuapp.com/booking/room-types/';
    ...
    const mealsUrl = 'https://react-forms-backend.herokuapp.com/booking/meals/';
  ...
  handleSubmit = () => {
    ...
    const url =
      'https://react-forms-backend.herokuapp.com/booking/booking-request/';
    const payload = {
      name: name.value,
      email: email.value,
      start: start.value,
  ...
  validatePhoneOnBE = event => {
    ...
    const url =
      'https://react-forms-backend.herokuapp.com/booking/check-phone/';
    axios
      .post(url, {phone})
      .then(response => {
